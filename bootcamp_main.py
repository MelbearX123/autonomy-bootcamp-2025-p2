...
HEARTBEAT_RECEIVER_OUTPUT_QUEUE_MAX_SIZE = -1
TELEMETRY_OUTPUT_QUEUE_MAX_SIZE = -1
COMMAND_OUTPUT_QUEUE_MAX_SIZE = -1
COMMAND_INPUT_QUEUE_MAX_SIZE = -1
...
def main() -> int:
    ...
    if not result:
        print("Failed to create arguments for heartbeat_receiver_worker")
        return -1
